...
def index():
    ...
    brand_story_banner = Banner.query.filter_by(is_active=True, position="brand_story").first()
    brand_story_image = brand_story_banner.image_url if brand_story_banner else 'https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=900&q=85'
